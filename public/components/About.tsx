          ...
          <div className="col-xl-6">
            ...
            >
              ...
              <p className="about-one__text-1">
                ...
                to the selection point. But in certain circumstances
              </p>

              <p className="about-one__text-2">
                Duis acute arura dolor in reprehenderit in voluptate velit esse
                cillum dolore Velit esse quam nihil molestiae consequatur, Velia
                ease chillum dolore eu fugato nullar partiture. Exception sint
                occaecatvel qui dolorem eum fugiat quo quail dolor sit amen,
                consectetur,
              </p>
