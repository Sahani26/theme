...
export const metadata = {
  title: "Short Circuit Repair | Your Website Name",
  description: "Professional Short Circuit Repair services for homes and businesses.",
};
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="service-details__left">
                <div className="service-details__img">
                  <Image src={serviceImg} alt="Short Circuit Repair" />
                </div>
              ...
              <div className="service-details__sidebar">
                <div className="service-details__services-box">
                  ...
                  <ul className="service-details__services-list list-unstyled">
                    ...
                    <li className="active"><a href="/services/short-circuit-repair">Short Circuit Repair<span className="icon-arrow-right"></span></a></li>
                    <li><a href="/services/commercial-services">Commercial services<span className="icon-arrow-right"></span></a></li>
